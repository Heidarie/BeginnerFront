...
const EmployerProfile = () => {
  ...
  const getEmployer = async (id) => {
    setLoading(true);
    if (id) {
      let response = await DataService.getEmployerProfile(id);
  ...
  return loading ? (
    <LoadingPage start="Trwa" decorated="ładowanie" end="profilu..." />
  ) : (
    <div>
      {employer ? (
                ...
                <div className="flex flex-row">
                  ...
                  <div className="text-xs text-gray-400/80 hover:text-gray-400">
                    ...
                    employer?.employerPersonalData?.street !== null
                      ...
                      : "Brak podanego adresu frimy"}
                  </div>
                </div>
              </div>

              <div className="flex max-w-md md:block md:max-w-2xl">
                <p className="text-md text-gray-400/80 hover:text-gray-400 mt-2">
                  {employer?.employerPersonalData?.description
                    ? employer?.employerPersonalData?.description
                    : "Brak podanego opis firmy"}
                </p>
              </div>
            </div>
        ...
        <NotFound
          message={"Przepraszam ale taki profil nie istnieje."}
          code={"400"}
        />
      )}
