  ...
  return (
    ...
    >
      <img
        className={
          !hover
            ? "h-28 lg:h-36 md:h-24 w-full object-cover object-center transition scale-110 ease-out duration-700"
            : "h-28 lg:h-36 md:h-24 w-full object-cover object-center transition scale-100 ease-out duration-700"
        }
      ...
      />
      <div className="p-2">
        <h4 className="mt-2 pb-2 text-2xl font-semibold text-gray-700 capitalize group-hover:text-white overflow-hidden">
          {title}
        </h4>
        ...
        {hover ? (
          ...
          >
            {benefits.map((benefit) => {
              return (
                <h1
                  className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-black group-hover:text-black overflow-hidden"
                  key={benefit}
                >
                  {benefit}
                </h1>
