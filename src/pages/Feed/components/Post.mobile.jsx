...
const Post = ({
  ...
  return (
    <div className="flex items-center justify-center my-5 drop-shadow-2xl">
      <div className="rounded-xl border p-5 shadow-md w-11/12 bg-white">
        ...
        <div className="mt-4 mb-6">
          ...
          <div
            className="flex items-center bg-cover object-fill max-h-[20rem] h-screen justify-center px-20 bg-gray-900 bg-opacity-40"
