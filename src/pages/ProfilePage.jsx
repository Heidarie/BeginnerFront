    ...
    <main className="grid grid-cols-1 lg:grid-cols-2 gap-6  w-2xl container px-2 mx-auto ">
        ...
        <aside className="my-10">
                ...
                <ul className="flex items-center justify-center space-x-2">
                    <li className="flex flex-col items-center space-y-2">
                        <a className="block bg-white p-1 rounded-full" href="#a">
                            <img className="w-16 rounded-full" alt='x' src="https://images.unsplash.com/photo-1638612913771-8f00622b96fb?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=200&amp;h=200&amp;q=80"/>
                        </a>
                    ...
                    <li className="flex flex-col items-center space-y-2">
                        <a className="block bg-white p-1 rounded-full" href="#a">
                            <img className="w-16 rounded-full" alt='x' src="https://images.unsplash.com/photo-1638649602320-450b717fa622?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=200&amp;h=200&amp;q=80"/>
                        </a>
                    ...
                    <li className="flex flex-col items-center space-y-2">
                        <a className="block bg-white p-1 rounded-full" href="#a">
                            <img className="w-16 rounded-full" alt='x' src="https://images.unsplash.com/photo-1638708644743-2502f38000a0?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=200&amp;h=200&amp;q=80"/>
                        </a>
                    ...
                    <li className="flex flex-col items-center space-y-2">
                        <a className="block bg-white p-1 rounded-full" href="#a">
                            <img className="w-16 rounded-full" alt='x' src="https://images.unsplash.com/photo-1638691899851-0e955bceba1f?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=200&amp;h=200&amp;q=80"/>
                        </a>
            ...
            <div className="grid mt-5 grid-cols-2  space-x-4 overflow-y-scroll justify-center items-center w-full ">
                    <div className="relative flex flex-col justify-between   bg-white shadow-md rounded-3xl  bg-cover text-gray-800  overflow-hidden cursor-pointer w-full object-cover object-center  h-64 my-2" style={{ backgroundImage: `url(${loginBg})` }}>
                    ...
                    <div className="relative flex flex-col justify-between   bg-white  rounded-3xl  bg-cover text-gray-800  overflow-hidden cursor-pointer w-full object-cover object-center shadow-md h-64 my-2" style={{ backgroundImage: `url(${loginBg})` }}>
        ...
        <article className="my-10">
            ...
            <div className="bg-white shadow rounded-lg mb-6">
                ...
                <div className="text-black p-4 antialiased flex">
                    <img alt='x' className="rounded-full h-8 w-8 mr-2 mt-1 " src="https://picsum.photos/id/1027/200/200"/>
                    <div>
            ...
            <div className="bg-white shadow rounded-lg mb-6">
                    ...
                    <div className="border-b border-gray-100"></div> 
                    <div className="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2">
                        <img alt='x' className="rounded w-full" src="https://picsum.photos/536/354"/>
                    </div>
