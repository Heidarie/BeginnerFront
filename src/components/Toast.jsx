...
const Toast = ({ text, icon }) => {
  return (
    <div
      id="toast-default"
      className="fixed left-5 bottom-5 z-10 flex items-center p-4 w-full max-w-fit text-gray-700 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
      role="alert"
    >
